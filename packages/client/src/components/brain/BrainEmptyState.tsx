...
export function BrainEmptyState({ variant = "warming" }: { variant?: BrainEmptyVariant }) {
  ...
  if (variant === "no-shared") {
    return (
      <div className="flex flex-col items-center px-6 py-16 text-center">
        <div className="flex size-16 items-center justify-center rounded-full bg-gold/10 border border-gold/20 shadow-[0_0_24px_var(--color-gold-muted)]">
          <Share2 className="size-7 text-gold" aria-hidden="true" />
        </div>
        <h2 className="mt-5 text-lg font-semibold bg-gradient-to-r from-[#FAFAFA] to-gold bg-clip-text text-transparent">
  ...
  return (
    <div className="flex flex-col items-center px-6 py-16 text-center">
      <div className="flex size-16 items-center justify-center rounded-full bg-gold/10 border border-gold/20 shadow-[0_0_24px_var(--color-gold-muted)]">
        <Brain className="size-7 text-gold" aria-hidden="true" />
      </div>
      <h2 className="mt-5 text-lg font-semibold bg-gradient-to-r from-[#FAFAFA] to-gold bg-clip-text text-transparent">
