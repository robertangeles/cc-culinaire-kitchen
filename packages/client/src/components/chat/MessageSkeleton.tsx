    ...
    <div className="flex-1 overflow-y-auto px-4 py-6 animate-pulse">
      <div className="max-w-3xl mx-auto flex flex-col gap-6">
        ...
        <div className="flex justify-end">
          <div className="h-9 w-48 rounded-2xl bg-dark-100" />
        </div>

        {/* Assistant message skeleton — multi-line */}
        <div className="flex gap-3">
          <div className="size-8 rounded-full bg-dark-100 shrink-0 mt-1" />
          <div className="flex flex-col gap-2 flex-1 max-w-lg">
            ...
            <div className="h-4 w-5/6 rounded bg-dark-100" />
        ...
        <div className="flex justify-end">
          <div className="h-9 w-36 rounded-2xl bg-dark-100" />
        </div>
        ...
        <div className="flex gap-3">
          ...
          <div className="flex flex-col gap-2 flex-1 max-w-md">
            ...
            <div className="h-4 w-3/5 rounded bg-dark-100" />
          </div>
        </div>
      </div>
    </div>
