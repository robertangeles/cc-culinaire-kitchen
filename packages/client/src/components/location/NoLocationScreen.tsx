    ...
    <div className="flex-1 overflow-y-auto bg-dark">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="text-center mb-8">
          <MapPin className="size-10 mx-auto mb-3 text-gold" />
          <h1 className="text-2xl md:text-3xl font-bold text-white">
            Run the Kitchen
          </h1>
          <p className="text-dark-600 mt-2 max-w-lg mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-3xl mx-auto">
          ...
          {!success ? (
            <div className="bg-dark-50 border border-dark-200 rounded-xl p-6 space-y-4">
              ...
              <div className="space-y-3">
                <input
                  ...
                  className="w-full px-4 py-2.5 text-sm rounded-lg
                    ...
                    placeholder:text-dark-500 font-mono tracking-wider
            ...
            <div className="bg-gold/10 border border-gold/20 rounded-xl p-6 flex flex-col items-center justify-center">
          ...
          <div className="space-y-4">
            ...
            <div className="bg-dark-50 border border-dark-200 rounded-xl p-5">
              <div className="flex items-center gap-2 mb-2">
                <UserPlus className="size-5 text-dark-600" />
            ...
            <div className="bg-dark-50 border border-dark-200 rounded-xl p-5">
              <div className="flex items-center gap-2 mb-2">
                <Building2 className="size-5 text-dark-600" />
                <h3 className="text-sm font-semibold text-[#E5E5E5]">
                  Are You the Admin?
                </h3>
              </div>
              <p className="text-sm text-dark-500 leading-relaxed mb-3">
                Create your first store location in your organisation settings
                to unlock the Run the Kitchen tools.
              </p>
              <Link
                to="/profile"
                className="inline-flex items-center gap-1.5 text-sm text-gold hover:text-gold-hover font-medium transition-colors"
              >
