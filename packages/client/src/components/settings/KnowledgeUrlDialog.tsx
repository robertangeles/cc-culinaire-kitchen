        ...
        <form onSubmit={handleSubmit} className="p-5 space-y-4">
          <div>
            ...
            <div className="relative">
              <Globe className="absolute left-3 top-2.5 size-4 text-dark-600" />
              <input
                type="url"
                value={url}
                onChange={(e) => setUrl(e.target.value)}
                className="w-full pl-9 pr-3 py-2 border border-dark-200 rounded-lg text-sm focus:ring-2 focus:ring-gold/50 focus:border-gold"
              ...
              <button
                ...
                className={`flex-1 flex items-center justify-center gap-2 px-3 py-2.5 text-sm font-medium rounded-lg border transition-colors ${
                  !crawl
                    ...
                    : "border-dark-200 bg-dark-50 text-[#E5E5E5] hover:bg-dark"
                }`}
              >
