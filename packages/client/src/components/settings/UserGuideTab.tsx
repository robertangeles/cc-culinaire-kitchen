        ...
        <div className="bg-dark-50 border border-dark-200 rounded-xl p-5 space-y-4">
          ...
          <div className="flex items-center gap-4">
            <div className="flex-1">
              <label className="block text-xs text-dark-600 mb-1 uppercase tracking-wider">
                Title
              </label>
              <input
                type="text"
                ...
                className="w-full bg-dark border border-dark-200 rounded-lg px-3 py-2 text-sm text-[#FAFAFA] placeholder-dark-500 focus:outline-none focus:border-gold transition-colors"
            ...
            <div className="flex items-center gap-3 pt-5">
              ...
              <button
                onClick={handleSave}
                disabled={saving}
                className="inline-flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-medium transition-colors bg-gold text-dark hover:bg-gold-hover disabled:opacity-50"
              >
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="space-y-1">
              <label className="block text-xs text-dark-600 uppercase tracking-wider">
                Markdown
              </label>
              <textarea
                value={currentGuide.content}
                onChange={(e) => updateField("content", e.target.value)}
                className="w-full min-h-[400px] bg-dark border border-dark-200 rounded-lg px-4 py-3 font-mono text-sm text-[#E5E5E5] placeholder-dark-500 resize-y focus:outline-none focus:border-gold transition-colors"
            ...
            <div className="space-y-1">
              ...
              <div className="min-h-[400px] bg-dark border border-dark-200 rounded-lg px-4 py-3 overflow-y-auto prose prose-invert prose-sm max-w-none">
