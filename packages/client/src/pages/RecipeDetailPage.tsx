    ...
    <div className="flex-1 overflow-y-auto bg-dark">
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="px-6 md:px-10 pb-8 mt-4">
          <div className="bg-dark-50 rounded-lg border border-dark-200 p-4">
            <p className="text-xs text-dark-500 leading-relaxed">
              <strong className="text-dark-600">AI-Generated Content:</strong> This recipe was generated by CulinAIre Kitchen,
