...
const ROUTES: Array<{ method: string; path: string; permission: string }> = [
  ...
  { method: "GET", path: "/templates", permission: "roster:manage" },
  { method: "POST", path: "/templates", permission: "roster:manage" },
  { method: "POST", path: "/templates/generate", permission: "roster:manage" },
  { method: "POST", path: "/templates/undo-generation", permission: "roster:manage" },
  { method: "PATCH", path: "/templates/:id", permission: "roster:manage" },
  { method: "DELETE", path: "/templates/:id", permission: "roster:manage" },
