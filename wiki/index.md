...
| [Workforce Optimisation](entities/workforce-optimisation.md) | Phase 3, in progress: demand forecasting per kitchen station from prep history (Slice 1, built); coverage heat map + shift swap (Slices 2-3, not started) | 2026-08-17 |
...
| [Storage Areas as Count Sheets](concepts/storage-areas.md) | Named places (Stock Room, Bar) organise the stocktake walk and hold per-area pars; counts SUM to the venue number, moves have ZERO stock effect — no per-area ledgers | 2026-07-15 |
