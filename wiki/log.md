...
- First slice of T14 (chosen: slice it, Labs chip first). Remaining T14: T14b rich self-service controls (is_pinned migration + pin/correct→re-embed/scope-toggle endpoints + D-T4 UI) and T14c org-admin management surface — both built to the locked D-T4 spec.
- Not yet committed/pushed. Next: T14b.
